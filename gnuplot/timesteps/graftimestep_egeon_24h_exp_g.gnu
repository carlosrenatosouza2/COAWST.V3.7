...
set terminal png    
set output 'graftimestep_egeon_24h_exp_g.gnu.png'
...
tempo_total_s = real(system("awk '{print $4}' tempototal_exp_g.txt"))
...
plot  'graftimestep_egeon_24h_exp_g.gnu_input_atm.txt' every ::1 using 2:1 with lines linecolor rgb 'red' title 'WRF (256c)', \
      'graftimestep_egeon_24h_exp_g.gnu_input_ocn.txt' every ::1 using 2:1 with lines linecolor rgb 'blue' title 'ROMS (256c)'
