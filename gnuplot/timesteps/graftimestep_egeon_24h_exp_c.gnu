...
set terminal png    
set output 'graftimestep_egeon_24h_exp_c.gnu.png'
...
tempo_total_s = real(system("awk '{print $4}' tempototal_exp_c.txt"))
...
plot  'graftimestep_egeon_24h_exp_c.gnu_input_atm.txt' every ::1 using 2:1 with lines linecolor rgb 'red' title 'WRF (64c)', \
      'graftimestep_egeon_24h_exp_c.gnu_input_ocn.txt' every ::1 using 2:1 with lines linecolor rgb 'blue' title 'ROMS (128c)'
