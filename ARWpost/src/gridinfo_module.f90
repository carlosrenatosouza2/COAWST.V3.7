...
MODULE gridinfo_module
   ...
   ! Variables
   integer                             :: interval_seconds, io_from_input
   ...
   logical                             :: extrapolate
   integer                             :: ncid 
   logical                             :: readOnce=.False.
   integer, allocatable, dimension(:)  :: ishape, ncDims
   integer                             :: nAtts
   ...
   SUBROUTINE get_namelist_params()
      ...
      namelist /io/       io_from_input, input_root_name, output_root_name,             &
