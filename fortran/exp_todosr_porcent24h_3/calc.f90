program porcent
   ...
   integer                       :: rank, unid=1000, ranki, nlinha, i, j, ji, cr
   ...
   !do rank = 1368, 1369
      ...
      do
         ...
         !print*, tempf, tempi, tempf-tempi, deltawaitsatm(rank), cr, rank, deltawaitsatm_porciclo(rank, cr)
         j=j+1
         cr=cr+1
      enddo
10    continue   
...
12    continue    
      ...
      !deltawaitsatm_med_porciclo = deltawaitsatm_med_porciclo +
      !deltawaitratm_med_porciclo = deltawaitratm_med_porciclo + 
   ...
   do cr=1, 49
      deltawaitsatm_med_porciclo(cr) = sum(deltawaitsatm_porciclo(:, cr))
      print*, cr, deltawaitsatm_med_porciclo(cr)
   enddo
   
   
   write(12, *) 'ATM - Media dos ranks: Timesteps, desv: '
   write(12, "(i2, f7.2)") 1, deltatimestepiatm_med
   do ji=1, 47
      write(12, "(i2, f7.2)")ji+1, deltatimestepnatm_med(ji)
   enddo
   write(12, *) ji+1, deltatimestepfatm_med
