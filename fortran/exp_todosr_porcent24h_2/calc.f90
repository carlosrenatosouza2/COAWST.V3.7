program porcent
   ...
   integer                    :: rank, unid=1000, ranki, nlinha, i, j
   ...
   real*8, dimension(1040)    :: deltainitatm = 0.0, deltarunatm = 0.0, deltafinaatm = 0.0, deltatotalatm = 0.0 
   real*8, dimension(1040)    :: deltainitocn = 0.0, deltarunocn = 0.0, deltafinaocn = 0.0
   real*8, dimension(1040)    :: deltawaitratm = 0.0, deltawaitsatm = 0.0
   real*8, dimension(1040)    :: deltawaitrocn = 0.0, deltawaitsocn = 0.0, deltatotalocn = 0.0
   real*8, dimension(1040, 2) :: temporunatm = 0.0, tempoinitatm = 0.0, tempofinaatm = 0.0
   real*8, dimension(1040, 2) :: temporunocn = 0.0, tempoinitocn = 0.0, tempofinaocn = 0.0
   ...
   do rank = 320, 1039
      ...
      do
         ...
         !print*, tempf, tempi, tempf-tempi, deltawaitsatm(rank)
         j=j+1
      enddo
10    continue   
      close(unid+rank)
...
11    continue    
      ...
      !print*, i, rank, deltawaitratm_med, deltawaitratm(rank)
   enddo
...
21    continue    
      ...
      !print*, rank, deltawaitrocn_med, deltawaitrocn(rank)
   enddo
