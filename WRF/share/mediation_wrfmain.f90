...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % force_use_old_data         = model_config_rec % force_use_old_data 
 ...
 grid % reasonable_time_step_ratio = model_config_rec % reasonable_time_step_ratio 
 ...
 grid % linear_interp              = model_config_rec % linear_interp 
 ...
 grid % gwd_used                   = model_config_rec % gwd_used 
 ...
 grid % tslist_ij                  = model_config_rec % tslist_ij 
 grid % tslist_unstagger_winds     = model_config_rec % tslist_unstagger_winds 
 ...
 grid % auto_levels_opt            = model_config_rec % auto_levels_opt 
 grid % max_dz                     = model_config_rec % max_dz 
 grid % dzbot                      = model_config_rec % dzbot 
 grid % dzstretch_s                = model_config_rec % dzstretch_s 
 grid % dzstretch_u                = model_config_rec % dzstretch_u 
 ...
 grid % physics_suite              = model_config_rec % physics_suite 
 ...
 grid % sf_surf_irr_scheme         = model_config_rec % sf_surf_irr_scheme (grid%id)
 grid % sf_surf_irr_alloc          = model_config_rec % sf_surf_irr_alloc 
 grid % irr_daily_amount           = model_config_rec % irr_daily_amount (grid%id)
 grid % irr_start_hour             = model_config_rec % irr_start_hour (grid%id)
 grid % irr_num_hours              = model_config_rec % irr_num_hours (grid%id)
 grid % irr_start_julianday        = model_config_rec % irr_start_julianday (grid%id)
 grid % irr_end_julianday          = model_config_rec % irr_end_julianday (grid%id)
 grid % irr_freq                   = model_config_rec % irr_freq (grid%id)
 grid % irr_ph                     = model_config_rec % irr_ph (grid%id)
 ...
 grid % bl_mynn_mixscalars         = model_config_rec % bl_mynn_mixscalars (grid%id)
 grid % bl_mynn_output             = model_config_rec % bl_mynn_output (grid%id)
 ...
 grid % cldovrlp                   = model_config_rec % cldovrlp 
 ...
 grid % num_urban_ndm              = model_config_rec % num_urban_ndm 
 grid % num_urban_ng               = model_config_rec % num_urban_ng 
 grid % num_urban_nwr              = model_config_rec % num_urban_nwr 
 grid % num_urban_ngb              = model_config_rec % num_urban_ngb 
 grid % num_urban_nf               = model_config_rec % num_urban_nf 
 grid % num_urban_nz               = model_config_rec % num_urban_nz 
 grid % num_urban_nbui             = model_config_rec % num_urban_nbui 
 grid % urban_map_zrd              = model_config_rec % urban_map_zrd 
 grid % urban_map_zwd              = model_config_rec % urban_map_zwd 
 grid % urban_map_gd               = model_config_rec % urban_map_gd 
 grid % urban_map_zd               = model_config_rec % urban_map_zd 
 grid % urban_map_zdf              = model_config_rec % urban_map_zdf 
 grid % urban_map_bd               = model_config_rec % urban_map_bd 
 grid % urban_map_wd               = model_config_rec % urban_map_wd 
 grid % urban_map_gbd              = model_config_rec % urban_map_gbd 
 grid % urban_map_fbd              = model_config_rec % urban_map_fbd 
 ...
 grid % flag_sm_adj                = model_config_rec % flag_sm_adj 
 ...
 grid % bmj_rad_feedback           = model_config_rec % bmj_rad_feedback (grid%id)
 ...
 grid % dust_emis                  = model_config_rec % dust_emis 
 grid % erosion_dim                = model_config_rec % erosion_dim 
 grid % no_src_types_cu            = model_config_rec % no_src_types_cu 
 grid % alevsiz_cu                 = model_config_rec % alevsiz_cu 
 grid % aercu_opt                  = model_config_rec % aercu_opt 
 grid % aercu_fct                  = model_config_rec % aercu_fct 
 grid % aercu_used                 = model_config_rec % aercu_used 
 ...
 grid % pxlsm_modis_veg            = model_config_rec % pxlsm_modis_veg (grid%id)
 ...
 grid % dm_has_traj                = model_config_rec % dm_has_traj (grid%id)
 ...
 grid % bucketf_opt                = model_config_rec % bucketf_opt 
 ...
 grid % morr_rimed_ice             = model_config_rec % morr_rimed_ice 
 grid % clean_atm_diag             = model_config_rec % clean_atm_diag 
 grid % calc_clean_atm_diag        = model_config_rec % calc_clean_atm_diag 
 ...
 grid % opt_soil                   = model_config_rec % opt_soil 
 grid % opt_pedo                   = model_config_rec % opt_pedo 
 grid % opt_crop                   = model_config_rec % opt_crop 
 ...
 grid % dk_zfac_q                  = model_config_rec % dk_zfac_q (grid%id)
 grid % ktrop                      = model_config_rec % ktrop 
 ...
 grid % max_rot_angle_gwd          = model_config_rec % max_rot_angle_gwd 
 ...
 grid % diff_6th_slopeopt          = model_config_rec % diff_6th_slopeopt (grid%id)
 grid % diff_6th_thresh            = model_config_rec % diff_6th_thresh (grid%id)
 ...
 grid % moist_mix2_off             = model_config_rec % moist_mix2_off (grid%id)
 grid % chem_mix2_off              = model_config_rec % chem_mix2_off (grid%id)
 grid % tracer_mix2_off            = model_config_rec % tracer_mix2_off (grid%id)
 grid % scalar_mix2_off            = model_config_rec % scalar_mix2_off (grid%id)
 grid % tke_mix2_off               = model_config_rec % tke_mix2_off (grid%id)
 grid % moist_mix6_off             = model_config_rec % moist_mix6_off (grid%id)
 grid % chem_mix6_off              = model_config_rec % chem_mix6_off (grid%id)
 grid % tracer_mix6_off            = model_config_rec % tracer_mix6_off (grid%id)
 grid % scalar_mix6_off            = model_config_rec % scalar_mix6_off (grid%id)
 grid % tke_mix6_off               = model_config_rec % tke_mix6_off (grid%id)
 ...
 grid % multi_bdy_files            = model_config_rec % multi_bdy_files 
 ...
 grid % windfarm_tke_factor        = model_config_rec % windfarm_tke_factor 
 grid % ideal_case                 = model_config_rec % ideal_case 
 grid % hailcast_opt               = model_config_rec % hailcast_opt (grid%id)
 grid % haildt                     = model_config_rec % haildt (grid%id)
 ...
 grid % nfmc                       = model_config_rec % nfmc 
 grid % fmoist_run                 = model_config_rec % fmoist_run (grid%id)
 grid % fmoist_interp              = model_config_rec % fmoist_interp (grid%id)
 grid % fmoisti_run                = model_config_rec % fmoisti_run (grid%id)
 grid % fmoisti_interp             = model_config_rec % fmoisti_interp (grid%id)
 grid % fmoist_only                = model_config_rec % fmoist_only (grid%id)
 grid % fmoist_freq                = model_config_rec % fmoist_freq (grid%id)
 grid % fmoist_dt                  = model_config_rec % fmoist_dt (grid%id)
 grid % fmep_decay_tlag            = model_config_rec % fmep_decay_tlag 
 ...
 grid % fire_fmc_read              = model_config_rec % fire_fmc_read (grid%id)
 ...
 grid % fire_lsm_reinit            = model_config_rec % fire_lsm_reinit (grid%id)
 grid % fire_lsm_reinit_iter       = model_config_rec % fire_lsm_reinit_iter (grid%id)
 grid % fire_upwinding_reinit      = model_config_rec % fire_upwinding_reinit (grid%id)
 grid % fire_is_real_perim         = model_config_rec % fire_is_real_perim (grid%id)
 grid % fire_lsm_band_ngp          = model_config_rec % fire_lsm_band_ngp (grid%id)
 grid % fire_lsm_zcoupling         = model_config_rec % fire_lsm_zcoupling (grid%id)
 grid % fire_lsm_zcoupling_ref     = model_config_rec % fire_lsm_zcoupling_ref (grid%id)
 grid % fire_tracer_smoke          = model_config_rec % fire_tracer_smoke (grid%id)
 grid % fire_viscosity_bg          = model_config_rec % fire_viscosity_bg (grid%id)
 grid % fire_viscosity_band        = model_config_rec % fire_viscosity_band (grid%id)
 grid % fire_viscosity_ngp         = model_config_rec % fire_viscosity_ngp (grid%id)
 grid % fire_slope_factor          = model_config_rec % fire_slope_factor (grid%id)
 ...
 grid % spp                        = model_config_rec % spp (grid%id)
 grid % hrrr_cycling               = model_config_rec % hrrr_cycling 
 grid % spp_conv                   = model_config_rec % spp_conv (grid%id)
 grid % gridpt_stddev_spp_conv     = model_config_rec % gridpt_stddev_spp_conv (grid%id)
 grid % stddev_cutoff_spp_conv     = model_config_rec % stddev_cutoff_spp_conv (grid%id)
 grid % lengthscale_spp_conv       = model_config_rec % lengthscale_spp_conv (grid%id)
 grid % timescale_spp_conv         = model_config_rec % timescale_spp_conv (grid%id)
 grid % vertstruc_spp_conv         = model_config_rec % vertstruc_spp_conv 
 grid % iseed_spp_conv             = model_config_rec % iseed_spp_conv 
 grid % spp_pbl                    = model_config_rec % spp_pbl (grid%id)
 grid % gridpt_stddev_spp_pbl      = model_config_rec % gridpt_stddev_spp_pbl (grid%id)
 grid % stddev_cutoff_spp_pbl      = model_config_rec % stddev_cutoff_spp_pbl (grid%id)
 grid % lengthscale_spp_pbl        = model_config_rec % lengthscale_spp_pbl (grid%id)
 grid % timescale_spp_pbl          = model_config_rec % timescale_spp_pbl (grid%id)
 grid % vertstruc_spp_pbl          = model_config_rec % vertstruc_spp_pbl 
 grid % iseed_spp_pbl              = model_config_rec % iseed_spp_pbl 
 grid % spp_lsm                    = model_config_rec % spp_lsm (grid%id)
 grid % gridpt_stddev_spp_lsm      = model_config_rec % gridpt_stddev_spp_lsm (grid%id)
 grid % stddev_cutoff_spp_lsm      = model_config_rec % stddev_cutoff_spp_lsm (grid%id)
 grid % lengthscale_spp_lsm        = model_config_rec % lengthscale_spp_lsm (grid%id)
 grid % timescale_spp_lsm          = model_config_rec % timescale_spp_lsm (grid%id)
 grid % vertstruc_spp_lsm          = model_config_rec % vertstruc_spp_lsm 
 grid % iseed_spp_lsm              = model_config_rec % iseed_spp_lsm 
 grid % skebs_on                   = model_config_rec % skebs_on 
 grid % sppt_on                    = model_config_rec % sppt_on 
 grid % spp_on                     = model_config_rec % spp_on 
 grid % rand_perturb_on            = model_config_rec % rand_perturb_on 
 grid % num_stoch_levels           = model_config_rec % num_stoch_levels 
 grid % seed_dim                   = model_config_rec % seed_dim 
 ...
 grid % sbm_diagnostics            = model_config_rec % sbm_diagnostics (grid%id)
 ...
 grid % mean_diag                  = model_config_rec % mean_diag 
 grid % mean_freq                  = model_config_rec % mean_freq 
 grid % mean_interval              = model_config_rec % mean_interval (grid%id)
 grid % mean_diag_interval         = model_config_rec % mean_diag_interval (grid%id)
 grid % mean_diag_interval_s       = model_config_rec % mean_diag_interval_s (grid%id)
 grid % mean_diag_interval_m       = model_config_rec % mean_diag_interval_m (grid%id)
 grid % mean_diag_interval_h       = model_config_rec % mean_diag_interval_h (grid%id)
 grid % mean_diag_interval_d       = model_config_rec % mean_diag_interval_d (grid%id)
 grid % mean_diag_interval_mo      = model_config_rec % mean_diag_interval_mo (grid%id)
 grid % diurnal_diag               = model_config_rec % diurnal_diag 
 ...
 grid % hybrid_opt                 = model_config_rec % hybrid_opt 
 grid % etac                       = model_config_rec % etac 
 grid % num_wif_levels             = model_config_rec % num_wif_levels 
 grid % wif_input_opt              = model_config_rec % wif_input_opt 
 grid % diag_nwp2                  = model_config_rec % diag_nwp2 
 grid % solar_diagnostics          = model_config_rec % solar_diagnostics 
