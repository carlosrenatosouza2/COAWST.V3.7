...
!
     ...
     &                     MIXING(ng) % Akv,                            &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1615, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akt(:,:,:,itemp),               &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1638, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1754, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % Pair)
        IF (FoundError(status, nf90_noerr, 1842, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % Uwind)
        IF (FoundError(status, nf90_noerr, 1890, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Ur2d)
        IF (FoundError(status, nf90_noerr, 1952, MyFile)) THEN
          IF (Master) THEN
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Vr2d)
        IF (FoundError(status, nf90_noerr, 1968, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                       FORCES(ng) % stflx(:,:,itrc))
          IF (FoundError(status, nf90_noerr, 2004, MyFile)) THEN
            IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % lhflx)
        IF (FoundError(status, nf90_noerr, 2029, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % shflx)
        IF (FoundError(status, nf90_noerr, 2051, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % evap)
        IF (FoundError(status, nf90_noerr, 2096, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     FORCES(ng) % stflux(:,:,isalt))
        IF (FoundError(status, nf90_noerr, 2142, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % srflx)
        IF (FoundError(status, nf90_noerr, 2165, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % sustr)
        IF (FoundError(status, nf90_noerr, 2692, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % vmask,                            &
     &                     FORCES(ng) % svstr)
        IF (FoundError(status, nf90_noerr, 2718, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % bustr)
        IF (FoundError(status, nf90_noerr, 2740, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % vmask,                            &
     &                     FORCES(ng) % bvstr)
        IF (FoundError(status, nf90_noerr, 2762, MyFile)) THEN
          IF (Master) THEN
...
!
      ...
      IF (FoundError(exit_flag, NoError, 4611, MyFile)) RETURN
