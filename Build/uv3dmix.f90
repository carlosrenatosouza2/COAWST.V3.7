      MODULE uv3dmix_mod
!
!svn $Id: uv3dmix.F 1054 2021-03-06 19:47:12Z arango $
!================================================== Hernan G. Arango ===
...
!
!svn $Id: uv3dmix2_s.h 1054 2021-03-06 19:47:12Z arango $
!************************************************** Hernan G. Arango ***
!  Copyright (c) 2002-2021 The ROMS/TOMS Group                         !
!    Licensed under a MIT/X style license                              !
!    See License_ROMS.txt                                              !
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 30, 56, MyFile)
     ...
     &                    OCEAN(ng) % u,                                &
     &                    OCEAN(ng) % v)
      CALL wclock_off (ng, iNLM, 30, 96, MyFile)
!
      RETURN
