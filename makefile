...
ifdef USE_IOMOD
	@echo "RENATO: using IOmod:"
        FFLAGS += -I/mnt/beegfs/carlos.souza/Doutorado/COAWST.V3.7/IOmod/obj \
        -L/mnt/beegfs/carlos.souza/Doutorado/COAWST.V3.7/IOmod -lIOmod
endif
...
#CR:wrfhydroclean:
#CR:ifdef USE_WRFHYDRO
#CR:	cd $(WRFHYDRO_DIR); ls;                                   \
#CR:	 make clean;                                              \
#CR:	echo " "; echo " ";                                       \
#CR:	echo "cleaned wrf";
#CR:endif
