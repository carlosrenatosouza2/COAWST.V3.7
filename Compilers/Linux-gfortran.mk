# svn $Id: Linux-gfortran.mk 1054 2021-03-06 19:47:12Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
#
               FC := gfortran
#           FFLAGS := -pedantic -frepack-arrays
...
#CR: gcc errFFLAGS += -ftree-vectorize -ftree-loop-linear -funroll-loops -w -ffree-form -ffree-line-length-none -frecord-marker=4 -fconvert=big-endian
...
ifdef USE_IOMOD
FFLAGS += -I$(WRF_DIR)/../IOmod/obj
LIBS += -L$(WRF_DIR)/../IOmod -lIOmod
endif
